...
import { updateDesignAttributesAPI, deleteDesignAttributesAPI } from '../../../../lib/api';
import { toast } from 'sonner';
import { handleClick, handleDragOver } from '../../../../utils/dragDrop'
import filePath from '../../../../utils/filePath';
import AddChild from '../edit-menu/update/AddChild';
...
function UpdateForm() {
    ...
    return (
        <form onSubmit={handleUpdate} className='flex flex-col gap-1 w-[60vw] p-6 pb-0 bg-theme'>
            ...
            <AlertDialogTrigger id='close'></AlertDialogTrigger>
