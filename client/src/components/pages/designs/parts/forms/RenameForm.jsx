...
const RenameForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col gap-2'>
            <AlertDialogTitle className="text-dark font-medium py-2">Rename Attribute</AlertDialogTitle>
            <AlertDialogTrigger id='close' className='absolute top-3 right-3 shadow-none'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
                </svg>
            </AlertDialogTrigger>
            <AttributeNameInput newAttributeName={newAttributeName} setNewAttributeName={setNewAttributeName} />
